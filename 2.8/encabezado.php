...
<div class="back">
        <div class="menu container">
            <a href="index.php" class="logo narrable">
            ...
            <nav class="navbar">
                <ul>
                    <li><a class="narrable" href="index.php">Inicio</a></li>
                    <li>
                    <div class="menu-item">
                    ...
                    <li><a class="narrable" href="novedades.php">Novedades</a></li>
                    <li><a class="narrable" href="conocenos.php">Conócenos</a></li>
                    <?php if (isset($_SESSION['user_name'])): ?>
                        <li><a><span class="narrable">Usuario: <?php echo $_SESSION['user_name']; ?></span></a></li>
                    <li>
                        <div class="menu-item">
                            <a class="narrable">
                    ...
                    <?php else: ?>
                        <li><a class="narrable" href="sesion.php">Sesión</a></li>
                    <?php endif; ?>
