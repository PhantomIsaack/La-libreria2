...
if (isset($_POST['add_usuario'])) {
    ...
    $add_sql = "INSERT INTO usuarios (nombre, apellidos, telefono, email, password, token, confirmado) VALUES ('$nombre', '$apellidos', '$telefono', '$email', '$password', '$token', 1)";
    ...
    <div class="container">
        <form action="usuarios.php" method="POST"> 
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" class="input-text" placeholder="Nombre del usuario" required>
            </div>
            <div class="form-group">
                <label for="apellidos">Apellidos: </label>
                <input type="text" id="apellidos" name="apellidos" class="input-text" placeholder="Apellido del usuario" required>
            </div>
            <div class="form-group">
                <label for="telefono">Telefono: </label>
                <input type="number" id="telefono" name="telefono" class="input-number" placeholder="Telefono del usuario"  required>
            </div>
            <div class="form-group">
            ...
            <tr id="editForm-<?php echo $row['id_usuario']; ?>" style="display: none;">
                <td colspan="9">
                    <form action="usuarios.php" method="POST">
                        ...
                        <input type="text" name="apellidos" value="<?php echo $row['apellidos']; ?>" class="input-text" required>
                        <input type="number" name="telefono" value="<?php echo $row['telefono']; ?>" class="input-number" required>
