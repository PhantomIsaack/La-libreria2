...
<div class="container">
        <form action="ventas.php" method="POST">
            <div class="form-group">
                ...
                <input type="number" id="id_usuario" name="id_usuario" placeholder="id del usuario" class="input-number" required>
            </div>
            <div class="form-group">
                <label for="total">Total: </label>
                <input type="number" id="total" name="total" placeholder="Total de la venta" class="input-number" required>
            </div>
            <div class="form-group">
            ...
            <tr id="editForm-<?php echo $row['id_venta']; ?>" style="display: none;">
                <td colspan="9">
                    <form action="ventas.php" method="POST">
                        ...
                        <input type="number" name="id_usuario" value="<?php echo $row['id_usuario']; ?>" class="input-number" required>
                        <input type="number" name="total" value="<?php echo $row['total']; ?>" class="input-number" required>
