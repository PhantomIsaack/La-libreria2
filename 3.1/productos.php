    ...
    <div class="container">
        <form action="productos.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" id="precio" name="precio" placeholder="Precio del producto" class="input-number" required>
            </div>
            <div class="form-group">
                <label for="autor">Autor:</label>
                <input type="text" id="autor" name="autor" placeholder="Autor" class="input-text" required>
            </div>
            <div class="form-group">
            ...
            <tr id="editForm-<?php echo $row['id_producto']; ?>" style="display: none;">
                <td colspan="9">
                    <form action="productos.php" method="POST">
                        ...
                        <input type="number" name="precio" value="<?php echo $row['precio']; ?>" class="input-number" required>
                        <input type="text" name="autor" value="<?php echo $row['autor']; ?>" class="input-text" required>
