...
<main>
    <form id="contact-form" action="process_contact.php" method="POST">
        ...
        <input type="text" id="lastname" name="lastname" class="input-text" required>

        <label class="narrable" for="email">Gmail:</label>
        <input type="email" id="email" name="email" required>

        <label class="narrable" for="phone">Teléfono:</label>
        <input type="tel" id="phone" name="phone" class="input-number" required>
    ...
    <h3>Gmail:support@lalibreriaayuditas.com/h3>
    </article>
</main>
