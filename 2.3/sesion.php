...
if (isset($_POST['add_usuario'])) {
    ...
    if ($conn->query($add_sql) === TRUE) {
        echo "<script>alert('Registro exitoso. Tu contraseña temporal es: $password');</script>";
...
<section id="register-section">
    ...
    <form id="register-form" action="sesion.php" method="post">
        ...
        <label for="contra" class="narrable">La contraseña se le generara automaticamnete</label>
